...
const I18N = {
  ...
  crumb_home: "Inicio",
  ab_eyebrow: "Nosotros · Sin fines de lucro · Fundada en 2015",
  ab_title: "Ingenieros de la isla,",
  ab_title2: "para la isla",
  ab_intro: "El Nuclear Alternative Project es una organización sin fines de lucro 501(c)(3) creada por ingenieros puertorriqueños que trabajan en la industria nuclear de EE. UU., unidos para estudiar y educar sobre la energía nuclear avanzada como un camino limpio y resiliente para Puerto Rico.",
  ab_mv_eyebrow: "Por qué existimos",
  ab_mv_title: "Misión y visión",
  ab_mission_k: "Misión",
  ab_mission_t: "Informar, para que Puerto Rico decida",
  ab_mission_p: "Informar al pueblo de Puerto Rico sobre las innovaciones y capacidades de los reactores nucleares avanzados, para que la isla pueda tomar una decisión informada sobre la mejor manera de alcanzar sus metas energéticas.",
  ab_vision_k: "Visión",
  ab_vision_t: "Un mañana más verde y fuerte",
  ab_vision_p: "Un Puerto Rico más verde y tecnológicamente avanzado, impulsado por una cartera de energía limpia que incluya la nuclear, lo bastante confiable para resistir la próxima tormenta.",
  ab_story_eyebrow: "Nuestra historia",
  ab_story_title: "Cómo empezó",
  ab_story_p1: "A finales de 2015, Eddie Guerra —ingeniero sísmico— tomó el teléfono y llamó a sus amigos de la universidad: Angel Reyes, operador principal de reactores PWR, y Jesús Nuñez, ingeniero estructural. Los tres eran ingenieros puertorriqueños trabajando en la industria nuclear de EE. UU., y los tres veían lo mismo.",
  ab_story_p2: "Antes de que los reactores avanzados pudieran transformar el sector energético de Puerto Rico, la gente primero necesitaba entender sus beneficios y sus retos. Cuando Jesabel Rivera, experta en participación comunitaria, se unió al equipo, la misión cobró vida: convirtió la ingeniería rigurosa en conversaciones claras con las comunidades que vivirían con estas decisiones.",
  ab_story_quote: "«Juntos, podemos ayudar a Puerto Rico a entrar en un mañana más verde y tecnológicamente avanzado.»",
  ab_team_eyebrow: "Liderazgo",
  ab_team_title: "Las personas detrás de NAP",
  ab_team_lead: "Ingenieros, educadores y defensores puertorriqueños de toda la industria nuclear de EE. UU.",
  ab_role_ceo: "Director Ejecutivo · Cofundador",
  ab_bio_jn: "Ingeniero estructural y cofundador que lidera la estrategia, las alianzas y la promoción pública de NAP.",
  ab_role_cto: "Director de Tecnología · Cofundador",
  ab_bio_ar: "Operador principal de reactores PWR que aporta el liderazgo técnico e impulsa los estudios de viabilidad de NAP.",
  ab_role_founder: "Cofundador · Ingeniería y Asesoría",
  ab_bio_eg: "Ingeniero sísmico con más de una década de liderazgo en infraestructura civil y energética a nivel mundial.",
  ab_role_comm: "Participación Comunitaria",
  ab_bio_jr: "Experta en participación comunitaria que ayuda a educar al público y a conectar la investigación de NAP con la gente.",
  ab_role_team: "Equipo de Liderazgo",
  ab_bio_vl: "Parte del liderazgo de NAP, apoyando los programas y el alcance de la organización.",
  ab_bio_rm: "Parte del liderazgo de NAP, apoyando los programas y el alcance de la organización.",
  ab_adv_eyebrow: "Junta Asesora",
  ab_adv_title: "Guía de todo el sector",
  ab_adv_lead: "Asesores que guían a NAP en regulación, desarrollo de proyectos y aplicaciones de la industria.",
  ab_org_eyebrow: "La organización",
  ab_org_title: "Datos de la organización",
  ab_fact_status_l: "Estado",
  ab_fact_status_v: "Organización sin fines de lucro 501(c)(3)",
  ab_fact_est_l: "Fundada",
  ab_fact_loc_l: "Ubicación",
  ab_fact_loc_v: "Puerto Rico · EE.UU.",
  ab_cta_title: "¿Quieres ayudar o simplemente saber más?",
  ab_cta_p: "Explora nuestra investigación, apoya la misión o escríbenos: hay un lugar para todos.",
  ab_cta_btn1: "Participa",
  ab_cta_btn2: "Ver nuestro trabajo",
  ...
  about_more: "Lee nuestra historia completa y conoce al equipo →",
